...
const CollaborationShortlisted = ({category}) => {
      ...
      <div className="transaction-tabs">
        <button
          ...
          onClick={() => {
            ...
            navigate(`/dashboard/collaboration/${category}/shortlisted?tab=incoming`, {
              replace: true,
            });
          }}
        >
        ...
        <button
          ...
          onClick={() => {
            ...
            navigate(`/dashboard/collaboration/${category}/shortlisted?tab=outgoing`, {
              replace: true,
            });
          }}
        >
                  ...
                  >
                    ...
                    {/* Card */}
                    {
                      profiles?.map((profile, profileIndex)=>{
                        ...
                        return(
                        <div key={cardId} className={`shortlisted-card-full ${isAccordionExpanded ? "accordion-expanded" : ""}`}>
