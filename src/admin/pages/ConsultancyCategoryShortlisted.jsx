      ...
      <div className="transaction-tabs">
        <button
          ...
          onClick={() => {
            ...
            navigate(`/dashboard/professional-consultancy/${category}/shortlisted?tab=incoming`, {
              replace: true,
            });
          }}
        >
        ...
        <button
          ...
          onClick={() => {
            ...
            navigate(`/dashboard/professional-consultancy/${category}/shortlisted?tab=outgoing`, {
              replace: true,
            });
          }}
        >
